...
export type ADD_MOVIE_TO_LIST = typeof ADD_MOVIE_TO_LIST;
...
interface addMovieToList extends AnyAction{
...
export type MoviesActionType = addMoviesAction | removeFavoriteAction | addFavoriteAction | addMovieToList;
export type SearchActionType = addSearchResultAction | addMovieToList;
...
export const addMovieToList = (movie:MovieType):MoviesActionType => {
    return {
        type: ADD_MOVIE_TO_LIST,
        movie: movie
    }
